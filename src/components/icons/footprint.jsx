export default function FootprintIcon() {
  return (
    <svg
      className="w-4 inline-block transition-transform rotate-[-40deg] group-hover:rotate-[1deg] dark:fill-white"
      version="1.1"
      id="_x32_"
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"   // ✅ fixed
      viewBox="0 0 512 512"
      xmlSpace="preserve"                         // ✅ fixed
    >
